...
let s:mb.dark0       = ['#101112', 235]     " 16-17-18 
let s:mb.dark0a		 = ['#121314', 236]		" 18-19-20
let s:mb.dark1       = ['#141617', 237]     " 60-56-54
let s:mb.dark2       = ['#191A1C', 239]     " 80-73-69
let s:mb.dark3       = ['#1D1F21', 241]     " 102-92-84
let s:mb.dark4       = ['#222426', 243]     " 124-111-100

let s:mb.gray_245    = ['#303336', 245]     " 146-131-116
let s:mb.gray_244    = ['#27292B', 244]     " 146-131-116

let s:mb.light0      = ['#ebdbb2', 229]     " 253-244-193
let s:mb.light1      = ['#5B6066', 223]     " 235-219-178
let s:mb.light2      = ['#4F5459', 250]     " 213-196-161
let s:mb.light3      = ['#44484C', 248]     " 189-174-147
let s:mb.light4      = ['#393C40', 246]     " 168-153-132

let s:mb.bright_red     = ['#9d0006', 167]     " 251-73-52
let s:mb.bright_green   = ['#b8bb26', 142]     " 184-187-38
let s:mb.bright_yellow  = ['#fabd2f', 214]     " 250-189-47
let s:mb.bright_blue    = ['#83a598', 109]     " 131-165-152
let s:mb.bright_purple  = ['#d3869b', 175]     " 211-134-155
let s:mb.bright_aqua    = ['#8ec07c', 108]     " 142-192-124
let s:mb.bright_orange  = ['#fe8019', 208]     " 254-128-25

let s:mb.neutral_red    = ['#cc241d', 124]     " 204-36-29
let s:mb.neutral_green  = ['#98971a', 106]     " 152-151-26
let s:mb.neutral_yellow = ['#d79921', 172]     " 215-153-33
let s:mb.neutral_blue   = ['#458588', 66]      " 69-133-136
let s:mb.neutral_purple = ['#b16286', 132]     " 177-98-134
let s:mb.neutral_aqua   = ['#689d6a', 72]      " 104-157-106
let s:mb.neutral_orange = ['#d65d0e', 166]     " 214-93-14

let s:mb.faded_red      = ['#b21f19', 88]      " 157-0-6
let s:mb.faded_green    = ['#79740e', 100]     " 121-116-14
let s:mb.faded_yellow   = ['#b57614', 136]     " 181-118-20
let s:mb.faded_blue     = ['#076678', 24]      " 7-102-120
let s:mb.faded_purple   = ['#8f3f71', 96]      " 143-63-113
let s:mb.faded_aqua     = ['#427b58', 66]      " 66-123-88
let s:mb.faded_orange   = ['#af3a03', 130]     " 175-58-3
...
let s:bold_inverse = 'inverse,bold,'
if g:mybox_inverse == 0
  let s:bold_inverse = ''
endif
...
let s:bg0  = s:mb.dark0
let s:bg1  = s:mb.dark1
let s:bg2  = s:mb.dark2
let s:bg3  = s:mb.dark3
let s:bg4  = s:mb.dark4

let s:gray = s:mb.gray_245

let s:fg0 = s:mb.light0
let s:fg1 = s:mb.light1
let s:fg2 = s:mb.light2
let s:fg3 = s:mb.light3
let s:fg4 = s:mb.light4

let s:red    = s:mb.neutral_red
let s:green  = s:mb.neutral_green
let s:yellow = s:mb.neutral_yellow
let s:blue   = s:mb.neutral_blue
let s:purple = s:mb.neutral_purple
let s:aqua   = s:mb.neutral_aqua
let s:orange = s:mb.neutral_orange
...
let s:mb.neutral_red    = s:red
let s:mb.neutral_green  = s:green
let s:mb.neutral_yellow = s:yellow
let s:mb.neutral_blue   = s:blue
let s:mb.neutral_purple = s:purple
let s:mb.neutral_aqua   = s:aqua
let s:mb.neutral_orange = s:orange
...
if exists('g:mybox_hls_cursor')
  let s:hls_cursor = get(s:mb, g:mybox_hls_cursor)
endif

let s:number_column = s:bg4
if exists('g:mybox_number_column')
  let s:number_column = get(s:mb, g:mybox_number_column)
endif
...
if exists('g:gitgutter_override_sign_column_highlight') &&
  ...
  if exists('g:mybox_sign_column')
    let s:sign_column = get(s:mb, g:mybox_sign_column)
  endif
endif

let s:color_column = s:bg1
if exists('g:mybox_color_column')
  let s:color_column = get(s:mb, g:mybox_color_column)
endif

let s:vert_split = s:bg2
if exists('g:mybox_vert_split')
  let s:vert_split = get(s:mb, g:mybox_vert_split)
endif
...
let s:bold_invert_signs = ''
if exists('g:mybox_bold_invert_signs')
  if g:mybox_bold_invert_signs == 1
    let s:bold_invert_signs = s:bold_inverse
  endif
endif
...
call s:HL('myboxRedSignBold', s:red, s:sign_column, s:bold)
call s:HL('myboxRedSignBoldInverted', s:sign_column, s:mb.bright_red, s:bold)
call s:HL('myboxGreenSign', s:green, s:sign_column, s:invert_signs)
call s:HL('myboxGreenSignBold', s:green, s:sign_column, s:bold)
call s:HL('myboxGreenSignBoldInverted', s:sign_column, s:green, s:bold)
call s:HL('myboxYellowSign', s:yellow, s:sign_column, s:invert_signs)
call s:HL('myboxYellowSignBold', s:yellow, s:sign_column, s:bold)
call s:HL('myboxYellowSignBoldInverted', s:sign_column, s:yellow, s:bold)
call s:HL('myboxBlueSign', s:blue, s:sign_column, s:invert_signs)
call s:HL('myboxBlueSignBold', s:blue, s:sign_column, s:bold)
call s:HL('myboxBlueSignBoldInverted', s:sign_column, s:blue, s:bold)
call s:HL('myboxPurpleSign', s:purple, s:sign_column, s:invert_signs)
call s:HL('myboxPurpleSignBold', s:purple, s:sign_column, s:bold)
call s:HL('myboxPurpleSignBoldInverted', s:sign_column, s:purple, s:bold)
call s:HL('myboxAquaSign', s:aqua, s:sign_column, s:invert_signs)
call s:HL('myboxAquaSignBold', s:aqua, s:sign_column, s:bold)
call s:HL('myboxPurpleSignBoldInverted', s:sign_column, s:aqua, s:bold)
...
call s:HL('LineNr', s:fg3, s:mb.dark2)
call s:HL('cursorLine', s:mb.bright_orange, s:mb.dark0a)
call s:HL('cursorLineNr', s:mb.bright_orange, s:mb.dark0a)

" Column where signs are displayed
call s:HL('SignColumn', s:none, s:sign_column)

" Line used for closed folds
call s:HL('Folded', s:mb.faded_orange, s:bg1, s:italic)
...
call s:HL('Comment', s:fg1, s:none, s:italicize_comments)
call s:HL('Todo', s:mb.neutral_yellow, s:mb.faded_red, s:bold . s:italic)
call s:HL('Error', s:red, s:vim_bg, s:bold . s:inverse)

" Generic statement
hi! link Statement myboxRed
" if, then, else, endif, swicth, etc.
hi! link Conditional myboxRedBold
" for, do, while, etc.
hi! link Repeat myboxRedBold
" case, default, etc.
...
if g:mybox_improved_strings == 0
  call s:HL('String',  s:mb.bright_green, s:none, s:italicize_strings)
else
...
" Tell indent-guides we want to set our own colours
...
if g:indent_guides_auto_colors == 0
  if g:mybox_invert_indent_guides == 0
    ...
    call s:HL('IndentGuidesEven', s:vim_bg, s:bg3)
  else
    call s:HL('IndentGuidesOdd', s:vim_bg, s:bg3, s:inverse)
    call s:HL('IndentGuidesEven', s:vim_bg, s:bg1, s:inverse)
  endif
endif
...
call s:HL('SyntasticError', s:none, s:mb.faded_red, s:undercurl, s:red)
call s:HL('SyntasticWarning', s:none, s:none, s:undercurl, s:yellow)

hi! link SyntasticErrorSign myboxRedSignBoldInverted
hi! link SyntasticWarningSign myboxYellowSignBoldInverted
