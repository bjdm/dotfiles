-- TODO FIX DIAG_ERROR highlight group
local conditions = require("heirline.conditions")
local utils = require("heirline.utils")

-- Automatically load colors on change of colorscheme
...
local FileNameBlock = {
    ...
    init = function(self)
		...
		--		local win_bufs = vim.api.nvim_win_get_option(0, 'current_bufs')
...
local BufferListProvider = function(window)
	local bufs = vim.api.nvim_list_bufs()
	print(bufs)
end
...
local ScrollBar ={
	...
	-- TODO change back to bright_bg
	--hl = { fg = "blue", bg = "bright_bg" },
	hl = { fg = "blue", bg = "purple" },
}
...
local Diagnostics = {
	...
	static = {
		-- TODO troubleshoot why these signs aren't working
...
-- 		--utils.surround({ "", "" }, "purple", { hl = { fg = "gray", force = true }, FileNameBlock }),
-- 	},
